...
#define UNIT "KitchCon"           // [Unit] Name of the unit

#define FRIENDLY1 "%s1"          // [FriendlyName1] name used by, e.g. HomeAssistant
#define FRIENDLY2 "Kitchen Mood"          // [FriendlyName2] name used by, e.g. HomeAssistant
#define FRIENDLY3 "Kitchen Bar"          // [FriendlyName3] name used by, e.g. HomeAssistant
#define FRIENDLY4 "%s4"          // [FriendlyName4] name used by, e.g. HomeAssistant
#define FRIENDLY5 "Kitchen Pillar"          // [FriendlyName5] name used by, e.g. HomeAssistant
#define FRIENDLY6 "%s6"          // [FriendlyName6] name used by, e.g. HomeAssistant
#define FRIENDLY7 "Kitchen Sink"          // [FriendlyName7] name used by, e.g. HomeAssistant
...
#define MQTT_CLIENT "%sClient1"    // [MqttClient] MQTT client name

#define MQTT_TOPIC "kitchcon"        // [Topic] (unique) MQTT device topic
...
// global status
#define STATUS_LED  16            // [StatusLED]
...
#define OUT2_PIN    D2            // [Out2Pin]
#define OUT2_TYPE   OUTTYPE_ONOFF // [Out2Type]
#define OUT3_PIN    D1            // [Out3Pin]
#define OUT3_TYPE   OUTTYPE_ONOFF // [Out3Type]
#define OUT4_PIN    D3            // [Out4Pin]
#define OUT4_TYPE   OUTTYPE_NONE  // [Out4Type]
#define OUT5_PIN    D6            // [Out5Pin]
#define OUT5_TYPE   OUTTYPE_ONOFF // [Out5Type]
#define OUT6_PIN    D5            // [Out6Pin]
#define OUT6_TYPE   OUTTYPE_NONE  // [Out6Type]
#define OUT7_PIN    D4            // [Out7Pin]
#define OUT7_TYPE   OUTTYPE_ONOFF // [Out7Type]
