...
void loop() 
{
  ...
  if( !allInitialised )
  {
    ...
    {
        displayData(digitCodeMap[11], digitCodeMap[11],digitCodeMap[11],digitCodeMap[11]);
    }
    debugTime("A1");
  }
  else
  {
    ...
    {
      int td = 8;
      displayData(B0000001,0,0,0);
      delay(td);
    #if true
      delay(10);
    #else
      displayData(0,B0000001,0,0);
      delay(td);
      displayData(0,0,B0000001,0);
      delay(td);
      displayData(0,0,0,B0000001);
      delay(td);
      displayData(0,0,0,B0000010);
      delay(td);
      displayData(0,0,0,B0000100);
      delay(td);
      displayData(0,0,0,B0001000);
      delay(td);
      displayData(0,0,B0001000,0);
      delay(td);
      displayData(0,B0001000,0,0);
      delay(td);
      displayData(B0001000,0,0,0);
      delay(td);
      displayData(B0010000,0,0,0);
      delay(td);
      displayData(B0100000,0,0,0);
      delay(td);
    #endif
    }
  }
